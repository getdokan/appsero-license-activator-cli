...
/**
 * Dokan\AppseroLicenseActivator\Dependencies\Appsero Client
 *
...
class Client {
     ...
     *
     * @return Dokan\AppseroLicenseActivator\Dependencies\Appsero\Insights
     */
    ...
    public function updater() {
        ...
        _deprecated_function( __CLASS__ . '::updater', '2.0', '\Dokan\AppseroLicenseActivator\Dependencies\Appsero\Updater::init($client);, for more details please visit: https://appsero.com/docs/appsero-developers-guide/appsero-client/appsero-sdk-updater-changes/' );

        // initialize the new updater
        if ( method_exists( '\Dokan\AppseroLicenseActivator\Dependencies\Appsero\Updater', 'init' ) ) {
            \Dokan\AppseroLicenseActivator\Dependencies\Appsero\Updater::init( $this );
        }
    }
     ...
     *
     * @return Dokan\AppseroLicenseActivator\Dependencies\Appsero\License
     */
